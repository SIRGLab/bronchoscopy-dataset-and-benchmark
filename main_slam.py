...
if __name__ == "__main__":
    ...
    # SHI_TOMASI_ORB, FAST_ORB, ORB, ORB2, ORB2_FREAK, ORB2_BEBLID, 
    # BRISK, AKAZE, FAST_FREAK, SIFT, ROOT_SIFT, SURF, 
    # SUPERPOINT, FAST_TFEAT, CONTEXTDESC
    # tracker_config = FeatureTrackerConfigs.SUPERPOINT
    # configuration for LoFTR
